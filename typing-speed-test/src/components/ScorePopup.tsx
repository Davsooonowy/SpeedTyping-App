...
import {Button, Dialog, DialogContent, DialogTitle, Grid, Slide, SlideProps, Typography} from '@mui/material';
import {ACCURACY_DESCRIPTION, CPM_DESCRIPTION, WPM_DESCRIPTION} from '../assets/metricsDescriptions';
                ...
                <div style={{display: 'flex', justifyContent: 'center', marginTop: '20px'}}>
                    <Button
                        ...
                        sx={{
                            ...
                            '&:hover': {backgroundColor: Colors.first}
                        }}
                    >
                        Try Again
                    </Button>
